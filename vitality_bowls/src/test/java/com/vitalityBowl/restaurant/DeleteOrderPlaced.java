...
public class DeleteOrderPlaced {
	...
	public static void main(String[] args) throws IOException {
	    ...
	    myorderpage.clickondeleteIconofOrderedItem();
		myorderpage.handlePopup(driver, webdriverutility);
		myorderpage.verifyElementDeleted();
		driver.quit();
